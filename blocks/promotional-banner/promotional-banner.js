...
function bannerType1(block) {
  let source = window.innerWidth > 1024 ? block.querySelectorAll(".bannner-image img")[0].src.trim() : block.querySelectorAll(".bannner-image img")[1].src.trim();
  source = block.querySelectorAll("img").length > 1 ? source : block.querySelectorAll(".bannner-image img")[0].src.trim();
